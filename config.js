...
configData.general = {
  ...
  serverToken: "269b9149-429d-4353-8bce-03bb7414c116",            // A unique token to your application that servers will use to authenticate to each other
  welcomeMessage : "Hello! Welcome to the GMWars api",            // The welcome message seen by TCP and webSocket clients upon connection
